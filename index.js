...
exports.GPUComputationRenderer = exports.GPUComputationRendererVariable =
  void 0;
...
class GPUComputationRenderer {
  constructor(sizeX, sizeY, renderer) {
    ...
    this.mesh = new three_1.Mesh(
      new three_1.PlaneBufferGeometry(2, 2),
      this.passThruShader
    );
  ...
  createRenderTarget(
    sizeXTexture = this.sizeX,
    sizeYTexture = this.sizeY,
    wrapS = three_1.ClampToEdgeWrapping,
    wrapT = three_1.ClampToEdgeWrapping,
    minFilter = three_1.NearestFilter,
    magFilter = three_1.NearestFilter
  ) {
    let renderTarget = new three_1.WebGLRenderTarget(
      sizeXTexture,
      sizeYTexture,
      {
        wrapS,
  ...
  createTexture(sizeXTexture = this.sizeX, sizeYTexture = this.sizeY) {
    ...
    let texture = new three_1.DataTexture(
      a,
      this.sizeX,
      this.sizeY,
      three_1.RGBAFormat,
